...
pmcpid=$!
sleep 11
ssh yz70@virt02-rca.cs.rice.edu sysbench /usr/ports/benchmarks/sysbench/work/sysbench-1.0.12/src/lua/oltp_read_write.lua --threads=28 --mysql-host=10.79.20.116 --mysql-user=root --mysql-port=3306 --mysql-password=password --tables=1 --table-size=$TABLE_SIZE --events=1600000 --time=6000 run
