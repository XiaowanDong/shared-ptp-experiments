...
ssh root@10.79.20.116 <<EOF
	...
	ssh -n yz70@virt02-rca.cs.rice.edu sysbench /usr/ports/benchmarks/sysbench/work/sysbench-1.0.12/src/lua/oltp_read_write.lua --threads=14 --mysql-host=10.79.20.116 --mysql-user=root --mysql-port=3306 --mysql-password=password --tables=1 --table-size=$2 --events=160000 --time=6000 run
	mysql-server onestop
	cpuset -c -l 2,3,4,5 mysql-server onestart
	ssh -n yz70@virt02-rca.cs.rice.edu sysbench /usr/ports/benchmarks/sysbench/work/sysbench-1.0.12/src/lua/oltp_read_write.lua --threads=14 --mysql-host=10.79.20.116 --mysql-user=root --mysql-port=3306 --mysql-password=password --tables=1 --table-size=$2 --events=1600000 --time=6000 run
	cpuset -c -l 7 ./run_top.sh M_L_code_nosuperpg_data_superpg_rw $1 $2 kernel_all
	#mv results/out.txt results/mysql_ld_$1_1600000t_ro_4thrd_M_L_code_nosuperpg_data_superpg_rw_usr_116_3/
	#reboot -k kernel_all
EOF
sleep 180
...
ssh root@10.79.20.116 <<EOF
	...
	cpuset -c -l 2,3,4,5 mysql-server onestart
	ssh -n yz70@virt02-rca.cs.rice.edu sysbench /usr/ports/benchmarks/sysbench/work/sysbench-1.0.12/src/lua/oltp_read_write.lua --threads=14 --mysql-host=10.79.20.116 --mysql-user=root --mysql-port=3306 --mysql-password=password --tables=1 --table-size=$2 --events=1600000 --time=6000 run
	cpuset -c -l 7 ./run_top.sh M_L_nosuperpg_rw $1 $2 agg-data-superpg
	#mv results/out.txt results/mysql_ld_$1_1600000t_ro_4thrd_M_L_nosuperpg_rw_usr_116_3/
	#reboot -k agg-data-superpg
EOF
sleep 180
...
#	ssh -n yz70@virt02-rca.cs.rice.edu sysbench /usr/ports/benchmarks/sysbench/work/sysbench-1.0.12/src/lua/oltp_read_write.lua --threads=14 --mysql-host=10.79.20.116 --mysql-user=root --mysql-port=3306 --mysql-password=password --tables=1 --table-size=$2 --events=1600000 --time=6000 run
#	time -o time.txt ssh -n yz70@virt02-rca.cs.rice.edu sysbench /usr/ports/benchmarks/sysbench/work/sysbench-1.0.12/src/lua/oltp_read_write.lua --threads=14 --mysql-host=10.79.20.116 --mysql-user=root --mysql-port=3306 --mysql-password=password --tables=1 --table-size=$2 --events=1600000 --time=6000 run
...
ssh root@10.79.20.116 <<EOF
	...
	cpuset -c -l 2,3,4,5 mysql-server onestart
	ssh -n yz70@virt02-rca.cs.rice.edu sysbench /usr/ports/benchmarks/sysbench/work/sysbench-1.0.12/src/lua/oltp_read_write.lua --threads=14 --mysql-host=10.79.20.116 --mysql-user=root --mysql-port=3306 --mysql-password=password --tables=1 --table-size=$2 --events=1600000 --time=6000 run 
	cpuset -c -l 7 ./run_top.sh Ms_L_data_superpg_rw $1 $2 kernel_all
	#mv results/out*.txt results/mysql_ld_$1_1600000t_ro_4thrd_Ms_L_data_superpg_rw_usr_116_3/
	#reboot -k kernel_all
EOF
sleep 180
...
ssh root@10.79.20.116 <<EOF
	...
	cpuset -c -l 2,3,4,5 mysql-server onestart
	ssh -n yz70@virt02-rca.cs.rice.edu sysbench /usr/ports/benchmarks/sysbench/work/sysbench-1.0.12/src/lua/oltp_read_write.lua --threads=14 --mysql-host=10.79.20.116 --mysql-user=root --mysql-port=3306 --mysql-password=password --tables=1 --table-size=$2 --events=1600000 --time=6000 run 
	cpuset -c -l 7 ./run_top.sh Ms_L_data_nosuperpg_rw $1 $2 kernel
	#mv results/out*.txt results/mysql_ld_$1_1600000t_ro_4thrd_Ms_L_data_nosuperpg_rw_usr_116_3/
EOF
sleep 180
