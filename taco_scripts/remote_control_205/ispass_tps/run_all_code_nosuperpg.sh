...
#        cpuset -c -l 7 ./run_top.sh M-s_L 1.2G 5000000 kernel_all
#EOF
#sleep 180
...
#        cpuset -c -l 7 ./run.sh 10 M-s_L_connect 320 >& results/out.txt
#        mv results/out.txt results/postgres_320s_selectonly_10c_3000000t_2core_M-s_L_connect_116_usr_1/
#        reboot -k kernel_all
#EOF
#sleep 180
...
ssh root@10.79.20.116 << EOF
	...
	cd /home/xd10/tests/java
        ...
        cpuset -c -l 7 ./run_derby_nosuperpg_promo.sh L-s_J-s >& results/out.txt
        mv results/out.txt results/java_ld_derby_500ops_L-s_J-s_usr_2/
	reboot -k kernel_all
EOF
sleep 180
...
ssh root@10.79.20.116 << EOF
	...
	cd /home/xd10/tests/java
        ...
        cpuset -c -l 7 ./run_compiler_nosuperpg_promo.sh L-s_J-s >& results/out.txt
        mv results/out.txt results/java_ld_compiler_500ops_L-s_J-s_usr_2/
	reboot -k kernel_all
EOF
sleep 180
...
#        cpuset -c -l 7 ./run.sh M-s_L >& /home/xd10/tests/nodejs/results/out.txt
#        mv /home/xd10/tests/nodejs/results/out.txt /home/xd10/tests/nodejs/results/node_reactssr_ld_1500iter_6thrd_M-s_L_116_usr_1/
#        reboot -k kernel_all
#EOF
#sleep 180
#
...
#        cpuset -c -l 7 ./run.sh M-s_L >& results/out.txt
#        mv results/out.txt results/clang_ld_dhrystone_5000iters_M-s_L_116_usr_1/
#        reboot -k kernel_all
#EOF
#sleep 180
